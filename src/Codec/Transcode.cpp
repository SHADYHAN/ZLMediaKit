...
// The following legacy encoder utilities are imported from the older ZLMediaKit transcode
// implementation so that modules can reuse a battle-tested FFmpeg-based audio encoder
// (including an internal audio FIFO) alongside the existing decoder and resampler.
